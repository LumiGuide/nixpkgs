...
rec {
  mkParamOfType = type : default : description : {
    _type = "param";
    option = mkOption {
      inherit type;
      inherit default;
  ...
  mkOptionalStrParam = mkParamOfType (types.nullOr types.str) null;

  mkEnumParam = values : mkParamOfType (types.enum values);

  mkYesNoParam = default : description : {
    _type = "param";
    option = mkOption {
      type = types.bool;
      inherit default;
  ...
  mkOptionalIntParam = mkParamOfType (types.nullOr types.int) null;
  ...
  mkSepListParam = sep : default : description : {
    _type = "param";
    option = mkOption {
