...
in {
  ...
  connections = mkAttrsOfParams {
   ...
   '';
    ...
    send_cert = mkEnumParam ["ifasked" "yes" "no" ] "ifasked" ''
    ...
    remote = mkPrefixedAttrsOfParams {
      ...
      eap_id = mkOptionalStrParam ''
        ...
        %any the EAP-Identity method will be used to ask the client for an EAP
        identity.
      '';
    ...
    children = mkAttrsOfParams {
     ...
     '';
      ...
      mark_out = mkStrParam "0/0x00000000" ''
        ...
        traffic. The special value %unique sets a unique mark on each CHILD_SA
        instance.
        </para><para>
        An additional mask may be appended to the mark, separated by
        <literal>/</literal>. The default mask if omitted is
